                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-500px ps-12" placeholder="Search Customer" />
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--begin::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
                                    ...
                                    <button type="button" data-url="{{route('admin.customer.delete.multiple')}}" class="btn btn-danger" data-kt-customer-table-select="delete_selected">Delete Selected</button>
                                </div>
                                <!--end::Group actions-->
                            </div>
                            <!--end::Card toolbar-->
                    ...
                    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content w-100">
                                ...
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.customer.store') }}" id="kt_modal_add_customer_form">
                                    @csrf

                                    <!-- Header -->
                                    <div class="modal-header" id="kt_modal_add_customer_header">
                                        <h2 class="fw-bold">Add or Edit Customer</h2>
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="phone_number" required id="phone_number" class="form-control" placeholder="Enter phone number">
                                                </div>
...
@section('scripts')
    <script>
        var fetchUrl='{{route('admin.customer.fetch')}}';
    </script>
    ...
    <script src="{{ asset('custom/add-customer.js') }}"></script>
